...
function ($stateProvider, $locationProvider, $urlRouterProvider, helper) {
  ...
  $stateProvider
    ...
    .state('app.campaigns', {
        ...
        templateUrl: helper.basepath('campaigns.html'),
        resolve: helper.resolveFor('ngTable', 'moment'),
...
App.controller('AccountsController', ["$scope", "Account", "ngTableParams", function ($scope, Account, ngTableParams) {
...
App.controller('AccountsAddController', ["$scope", "Account", "$state", "toaster", "Poi", "$q", "Wxclient", function ($scope, Account, $state, toaster, Poi, $q, Wxclient) {
...
App.controller('CampaignsController', ["$scope", "Campaign", "ngTableParams", function ($scope, Campaign, ngTableParams) {
...
App.controller('CampaignController', ["$scope", "Campaign", "$state", "toaster", "Poi", "$q", function ($scope, Campaign, $state, toaster, Poi, $q) {
